        ...
        >
          ...
          <div className="glass-panel rounded-[2rem] p-6 sm:p-10">
            <div className="flex items-center gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/50 border border-white/60 text-indigo-900 rounded-2xl flex items-center justify-center shadow-sm shrink-0">
